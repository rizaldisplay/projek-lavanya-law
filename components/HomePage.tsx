...
export const HomePage: React.FC<NavigatablePageProps> = ({ onNavigate, isActive }) => {
  return (
     <div className={`halaman flex flex-col items-center justify-center text-center ${isActive ? 'translate-x-0 is-active' : '-translate-x-full'}`}>
